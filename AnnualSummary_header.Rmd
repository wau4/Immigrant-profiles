...
The Centers for Disease Control (CDC) determines the medical requirements for immigrant applicants.  Immigrant applications are processed overseas by those wishing to enter the United States 

- TODO: note on 'country', birth vs. present vs nationality 

- TODO: define country of origin (used for purpose od comparing panels/programs). exam country used for reviewing panels, presentcoutnry for refugee programs, like vaccine programs.

# Overview

```{r , fig.height= 6, fig.width = 8, fig.fullwidth = TRUE,  dpi=300, fig.cap= "Immigration Trends"}
...
grid.arrange(hexbin_map(fill_data = dataR,  text_size = 2, text_color = 'gray20', brewer_palatte = "Blues",
...
countries = unique(refs$Nationality)
...
```{r hexbin_grid, eval= FALSE, fig.width = 7.5, fig.height= 9, fig.fullwidth = TRUE, dpi=300, fig.cap= "Arrivals by state"}
...
dataR = edn.geo %>% 
  ...
  select(country.name, State) %>%
  group_by( country.name, State) %>%
  summarize(count= n()) %>%
...
grid.arrange(hexbin_map(fill_data = dataR, facet = text_size = 2, text_color = 'gray20',
                        chart_title = "Refugee Arrivals", legend_position = 'top'),
             hexbin_map(fill_data  = dataI, text_size = 2, text_color = 'gray20', 
                        chart_title = "Immigrant Notifications",legend_position = 'top'),
             ncol=2
             )

c1 = hexbin_map(fill_data  = dataI, text_size = 2, text_color = 'gray20', 
                        chart_title = "Immigrant Notifications",legend_position = 'top')

c2 = hexbin_map(fill_data  = dataI, text_size = 2, text_color = 'gray20', 
                        chart_title = "Immigrant Notifications",legend_position = 'right')
c = list(c1, c2  )
