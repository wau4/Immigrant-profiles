...
```{r , eval = TRUE, fig.height= 1.5, fig.width= 7.5, dpi=300, fig.cap= "Number of pulmonary TB cases diagnosed at **overseas** exam.  Points labeled with number of cases."}
...
```{r , eval = TRUE, fig.height= 2.25,  fig.width= 7.5, dpi=300, fig.cap= "Oversease TB screening by agegroup. (Data are from year in which most recent DHS denominator data was available.)"}
...
```{r , eval = TRUE, fig.height= 2,  fig.width= 7.5, dpi=300, fig.cap= "Percent of CLass B TB diagnosed with TB disease at **domestic** exam.  Points labeled with number of cases."}
...
```{r , eval = FALSE, fig.height= 2,  fig.width= 7.5, dpi=300, fig.cap= "Percent with abnormal chest radiograph"}
